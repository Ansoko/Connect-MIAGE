...
public class Board2 {
	...
	public void cornerResearch() { // recherche des coins se (num�ro 4)
	...
	private void followCircuit(int posI, int posJ) { //carr�ment pas fini
		int length = 1;
		int startI = posI, startJ = posJ;
		boolean flag = true;
		if(startJ+1 == LINE) { //si la case � droite n'est pas un mur
			flag = false;
		}
		posJ +=1;
